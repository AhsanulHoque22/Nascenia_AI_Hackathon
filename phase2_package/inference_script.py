...
Usage (from this directory, after running download_weights.sh):
    # score a val sample end-to-end (requires data/processed/val.jsonl)
    python inference_script.py --split val --n 200

    # generate the submission
    python inference_script.py --split test --out submission.csv
"""
...
def main():
    ...
    ap.add_argument("--adapter", default="weights/adapter",
                    help="PEFT adapter dir; run download_weights.sh first")
